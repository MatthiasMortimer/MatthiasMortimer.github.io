...
services:
  ...
  description: Popular solutions for business clients and aspiring engineers.
  link: View All Services & Pricing →
  items:
    - id: fullstack-web
    ...
    - id: mentorship-1on1
      ...
      deliverables:
        ...
        - Asynchronous code reviews between calls
        - Career advice and resume/portfolio guidance
      pricing: Starting at $55 / hour (Discounts for multi-session packages)
      popular: true
    - id: api-architecture
      category: Development
      ...
      deliverables:
        ...
        - Cloud deployment & Docker setups
    ...
    - id: custom-workshops
      ...
      deliverables:
        ...
        - Interactive Q&A and group project code reviews
        - Recorded video sessions for future reference
        - Post-workshop reference guides
      pricing: Custom pricing per cohort
    - id: code-reviews
      category: Teaching
      ...
      pricing: $50 per repository review
projects:
  title: Selected Projects & Curricula
  description: 'Recent client work, open-source tools, and teaching programs.'
  link: Browse Full Portfolio →
testimonials:
